...
class Model {
	...
	/**
	 * Builds and sends one automatic log per item for a multi write operation to the trace service,
	 * using each item id as entityId. Same gate and core resolution as _addLog().
	 *
	 * @param {string} type The log type
