...
class Model {
	...
	addCreatedData(item) {
		...
		item.userCreated = item.userCreated || this.userToSave;
		item.dateCreated = item.dateCreated || this.dateToSave;
	...
	addModifiedData(item = {}) {
		...
		item.userModified = item.userModified || this.userToSave;
		item.dateModified = item.dateModified || this.dateToSave;
