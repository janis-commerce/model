 ...
 * @property {Array<string>} [entityIds] The parallel entity ids, carried by grouped (batched) writes; individual writes carry the singular entityId instead
...
module.exports = class LogHelper {
	 ...
	 * @param {Array<string>} [entityIds] The parallel entity ids (grouped writes only)
	 * @return {Log}
	 * @private
	 */
